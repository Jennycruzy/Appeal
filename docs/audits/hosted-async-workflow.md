...
Recorded 2026-08-31 against Cloud Run revision `appeal-backend-00022-952` in
...
The case was `case-hosted-payer-clean-20260831` in the synthetic tenant
`tenant-demo-hosted-payer-clean-20260831`. The payer event contained only
...
mutation count unchanged. Firestore showed one processed event ID and the
reference-only payer event in the case event collection.
